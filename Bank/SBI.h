...
string branch;
string date;
SBI(string name,string type,string branch,string date,int interest,bool gold,bool land,bool personal,string goldLoanDocuments,string landLoanDocuments,string personalLoanDocuments):
