...
public List removeOneDecimalValue(List object,Object number)throws Exception
{
nullCheck(object);
...
public List combineTwoList(List object,List secondObject)throws Exception
{
 nullCheck(object);
 object.addAll (secondObject);
 return object;
}
...
public List sameElementRetain(List object,List secondObject) throws Exception
{
nullCheck(object);
 object.retainAll(secondObject);
 return object;
}

public List removeFirstArray(List object,List secondObject)throws Exception
{
nullCheck(object);
 secondObject.removeAll(object);
 return secondObject;
}
}
