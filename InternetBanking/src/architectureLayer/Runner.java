...
//	 }
	...
	{
	 System.out.println("Are you  have  an existing account"
...
public void checkLogin() throws CustomException
{
	...
	CustomerInformation cusInfo=mapObj.get(userName);
	
	boolean  value=cusInfo.getRole();
	if(password.equals("admin") &&  value==true  )
	{
	   adminLogin();	
	}
	else
    ...
    int count=0;
	if(cusInfo.getPassword().equals(password) && value==false )
	{
